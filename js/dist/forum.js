...
/***/ "./src/common/components/ModalWeight.js":
/*!**********************************************!*\
  !*** ./src/common/components/ModalWeight.js ***!
  \**********************************************/
...
/* harmony export */   "default": () => (/* binding */ ModalWeight)
/* harmony export */ });
...
var ModalWeight = /*#__PURE__*/function (_Modal) {
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(ModalWeight, _Modal);
  function ModalWeight() {
    return _Modal.apply(this, arguments) || this;
  }
  var _proto = ModalWeight.prototype;
  ...
  _proto.onready = function onready() {
    _Modal.prototype.onready.call(this);
    var index = this.attrs.index;
    // 创建一个Croppie实例
    var c = new (croppie__WEBPACK_IMPORTED_MODULE_2___default())(document.getElementById('upload-preview'), {
      viewport: {
        width: 200,
        height: 200,
        type: 'square'
    ...
    document.getElementById('crop-button').addEventListener('click', function () {
      c.result('base64').then(function (base64) {
        ...
        app.request({
          ...
          body: data
        }).then(index.success.bind(index), index.failure.bind(index)).then(function () {
          app.modal.close();
        });
      });
    });
  ...
  _proto.content = function content() {
    ...
    return m("div", {
      ...
      id: "upload-button",
      className: "Button Button--primary IndexPage-newDiscussion hasIcon",
      style: "float: right; margin-bottom: 20px; margin-right: 20px;"
    }, "\u9009\u62E9\u56FE\u7247"), m("button", {
      id: "crop-button",
      className: "Button Button--primary IndexPage-newDiscussion hasIcon",
      style: "display: none; float: right; margin-bottom: 20px; margin-right: 20px;"
    }, "\u88C1\u526A"));
  };
...
ModalWeight.isDismissible = true;
...
/* harmony import */ var _common_components_ModalWeight__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../common/components/ModalWeight */ "./src/common/components/ModalWeight.js");





flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('widayn/flarum-avatar-cropper', function () {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.override)((flarum_forum_components_AvatarEditor__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'quickUpload', function (original, e) {
    if (!this.attrs.user.avatarUrl()) {
      e.preventDefault();
      e.stopPropagation();
      flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().modal.show(_common_components_ModalWeight__WEBPACK_IMPORTED_MODULE_4__["default"], {
        'index': this
      });
    }
  });
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_AvatarEditor__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'controlItems', function (items) {
